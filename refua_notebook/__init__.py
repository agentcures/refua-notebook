...
_pkg_version: Callable[[str], str] | None
try:
    from importlib.metadata import version as _pkg_version
except Exception:  # pragma: no cover - Python <3.8 or broken metadata
    _pkg_version = None
...
if _pkg_version is None:
    ...
    try:
        __version__ = _pkg_version("refua-notebook")
    except Exception:  # pragma: no cover - metadata not available
        __version__ = "0.0.0"
